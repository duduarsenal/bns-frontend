...
export default function MoradorCard({bloco, apartamento, morador, proprietario}: IMorador){
    return (
        <section className="border-[3px] border-[#4C9773] w-full rounded-lg min-h-[80px] px-4 justify-between flex font-normal text-[#4C9773]">
